        ...
        <div class="modal-content">
          <div class="card">
            <div class="card-block">
              {!! Form::model($admin, ['route' => ['PresidentProfileUpdate', $admin->id], 'data-parsley-validate' => '',
                'method' => 'PUT']) !!}
                {{-- header --}}
...
<!--profile Modal-->
    <div class="modal fade" id="password" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
          <div class="card">
            <div class="card-block">
              <form class="" action="{{url('preschangepassword')}}" method="post" data-parsley-validate = "" >
                {{-- header --}}
                <div class="text-xs-center">
