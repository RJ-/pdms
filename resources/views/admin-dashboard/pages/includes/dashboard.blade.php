...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [windowvar.fcas, windowvar.fcbm, windowvar.fcoed, windowvar.fcet,
                  // windowvar.fcaramoan, windowvar.flagonoy,
          ...
          },
          {
            ...
            data: [windowvar.cas, windowvar.cbm, windowvar.coed, windowvar.cet
                  // ,windowvar.caramoan, windowvar.lagonoy,
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [windowvar.caspd, windowvar.cbmpd, windowvar.coedpd, windowvar.cetpd
                    // ,windowvar.caramoanpd, windowvar.lagonoypd,
