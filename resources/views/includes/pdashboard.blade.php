<script>
var ctx = document.getElementById("pfaculty");
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            backgroundColor: ["#0D47A1","#0D47A1", "#0D47A1", "#0D47A1", "#0D47A1", "#0D47A1", "#0D47A1", "#0D47A1", "#0D47A1"]
          },
          {
...
<script>
var ctx = document.getElementById("ppd");
var myChart = new Chart(ctx, {
    type: 'horizontalBar',
    data: {
        labels: ["College of Arts and Sciences", "College of Bus. and Mgt.",
