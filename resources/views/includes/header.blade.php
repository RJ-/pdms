  ...
  <nav class="navbar navbar-dark navbar-fixed-top scrolling-navbar">
      ...
      <div class="container">
          ...
          <div class="collapse navbar-toggleable-xs" id="collapseEx2">
              <!--Navbar Brand-->
              <a class="navbar-brand" style="color: #FFF" href="{{route('home')}}">
                <img src="{{asset('images/logo.png')}}" width="30px" alt="LOGO"> PDMS</a>
              <!--Links-->
              @if (Auth::check())
                <ul class="nav navbar-nav pull-right">
                  <li class="nav-item">
                    <a class="navbar-brand" style="color: #FFF" href="{{route('faculty.show', Auth::user()->id)}}">{{Auth::user()->firstname}}</a>
                  </li>
                  <li class="nav-item dropdown btn-group">
                      ...
                      <div class="dropdown-menu dropdown" aria-labelledby="dropdownMenu1" id="markasread" onclick="markNotificationAsRead('{{count(auth()->user()->unreadNotifications)}}')">
                        <a href="#"><small class="text-primary"><b><em>Your Notifications</em></b></small></a>
                        <hr>
                        ...
                        @endforelse
                          <center><small style="font-size:11px"><a class="dropdown-item text-primary" href="{{route('notification.index')}}">View all notifications</a></small></center>
                      </div>
                  </li>
                  <li class="nav-item dropdown btn-group">
                      ...
                      <div class="dropdown-menu dropdown" aria-labelledby="dropdownMenu1">
                        <a class="dropdown-item" href="{{route('pdrecord', Auth::user()->id)}}"><i class="fa fa-sliders"></i> Manage PD Record </a>
                          <a class="dropdown-item" href="{{route('faculty.edit', Auth::user()->id)}}"><i class="fa fa-gears"></i> Manage Profile </a>
